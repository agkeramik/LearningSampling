...
#include <iostream>
#include <cmath>
ExpansionCostCalculator::ExpansionCostCalculator()
{
}

double ExpansionCostCalculator::calculateCost(const Room &room)
{
...
//         <<ClipperLib::IntPoint(room.getBottomRightCornerX()-shift,room.getTopLeftCornerY()+shift);
    ...
    return -sqrt(area/10000);
}

void ExpansionCostCalculator::print(std::ostream &out)
{
    out<<"Expansion Cost: ";
}
